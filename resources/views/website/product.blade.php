                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="single-services d-flex align-items-center mb-0">
                            <div class="features-img">
                                <img width="10%" src="{{url($Product->image1)}}" alt="{{$Product->name}}">
                            </div>
            ...
            <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                ...
                <div class="row">
                    <div class="offset-xl-1 col-lg-9">
                        @if ($Product->image2)
                            <img width="10%" src="{{url($Product->image2)}}" alt="{{$Product->name}}"><br><br>
                        @endif
                        @if ($Product->image3)
                            <img width="10%" src="{{url($Product->image3)}}" alt="{{$Product->name}}"><br><br>
                        @endif
