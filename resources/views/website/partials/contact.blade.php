        ...
        <div class="row" dir="{{Session::get('locale') == 'ar'?'rtl':'ltr'}}">
            ...
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="/contact" method="POST">
                    ...
                    <div class="form-group mt-3">
                        <button type="submit" class="button button-contactForm boxed-btn">{{__('content.Send')}}</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-3 offset-lg-1">
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <p style="color:black!important;font-size:16px;" dir="ltr">+966 5 6444 2238</p>
