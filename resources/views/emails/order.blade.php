                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://ygebpn.stripocdn.email/content/guids/CABINET_09eee55658396dfc539741b81c5f0ee3469977cfcf2937de06298fb3817de1d3/images/unnamed.png"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <strong>Track your order</strong></h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                            ...
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                    ...
                                    @php
                                        ...
                                        $discount=0;
                                    @endphp
                                    @foreach ($mailData['Order']['orderItems'] as $orderItem)
                                        @php
                                                                            ...
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <strong>{{$orderItem->product->name_en}}</strong></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Subtotal:&nbsp;<strong>{{$sum}} {{$mailData['Currency']}}</strong><br>Shipping:&nbsp;<strong>{{ ($mailData['Order']['delivery_price']) }} {{$mailData['Currency']}}</strong><br>Discount:&nbsp;<strong>{{$discount}} {{$mailData['Currency']}}</strong><br>Total:&nbsp;<strong>{{ (($sum + $mailData['Order']['delivery_price'])-$discount) }} {{$mailData['Currency']}}</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Customer:
                                                                        <strong>{{$mailData['Customer']}}</strong></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Order number:&nbsp;<strong>#{{$mailData['Order_number']}}</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Invoice date:&nbsp;<strong>{{$mailData['Invoice_date']}}</strong><br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-l"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Payment method:&nbsp;<strong>{{$mailData['Payment_method']}}</strong></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Currency:&nbsp;<strong>{{$mailData['Currency']}}</strong></p>
                                                                    <strong></strong>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Shipping address:&nbsp;<strong>{{$mailData['Shipping_address']}}<br></strong></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <p
                                                            ...
                                                            Got a question? Email us at&nbsp;<a
                                                                target="_blank" href=""
                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">{{env('MAIL_EMAIL')}}</a>&nbsp;or
                                                            give us a call at&nbsp;<a target="_blank"
                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px;line-height:21px"
                                                                href="">{{env('MAIL_PHONE')}}</a>.</p>
                                                        <p
                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                            <br>Thanks
                                                        </p>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        by&nbsp;<a href="{{url('/')}}"
                                                                            target="_blank"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px">{{url('/')}}</a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
