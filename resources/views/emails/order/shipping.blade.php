                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10b es-m-txt-c">
                                                                    <h1 style="font-size: 46px;line-height: 46px">Order
                                                                        confirmation</h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p>This email is to confirm&nbsp;your order. We will
                                                                        send you another email as soon as it ships.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center">
                                                                    <!--[if mso]><a href="" target="_blank" hidden> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" style="height:44px; v-text-anchor:middle; width:292px" arcsize="14%" strokecolor="#5c68e2" strokeweight="2px" fillcolor="#5c68e2"> <w:anchorlock></w:anchorlock> <center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:18px; font-weight:400; line-height:18px; mso-text-raise:1px'>TRACK ORDER STATUS</center> </v:roundrect></a><![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                ...
                                                <tr>
                                                    <td width="560" class="es-m-p0r" align="center">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            role="presentation">
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r es-p10t es-p20b">
                                                                    <p>Subtotal:&nbsp;<strong>$40.00</strong><br>Shipping:&nbsp;<strong>$0.00</strong><br>Tax:&nbsp;<strong>$10.00</strong><br>Total:&nbsp;<strong>$50.00</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr>
                                        <td class="es-p20t es-p10b es-p20r es-p20l" align="left">
                                            ...
                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                <tr>
                                                    <td width="280" class="es-m-p0r es-m-p20b" align="center">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation">
                                                            <tr>
                                                                <td align="left">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-l">
                                                                    <p>Shipping Method: <strong>UPS - Ground</strong>
                                                                    </p>
                                                                    <p>Shipping address:</p>
                                                                    <p><strong>Sarah Powell,<br>600 Montgomery
                                                ...
                                                <tr>
                                                    <td width="560" align="left">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b">
                                                                    <p>Got a question?&nbsp;Email us at&nbsp;<a
                                                                            target="_blank"
                                                                            href="mailto:">support@</a><a
                                                                            target="_blank"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p35b">
                                                                    <p>Smart core-ksa© 2023l, Inc. All Rights
                                                                        Reserved.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
