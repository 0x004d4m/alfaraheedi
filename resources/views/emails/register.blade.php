                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10b es-m-txt-c">
                                                                    <h1 style="font-size: 46px;line-height: 46px">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p5b">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p10t es-p10b">
                                                                    <!--[if mso]><a href="" target="_blank" hidden> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" style="height:43px; v-text-anchor:middle; width:282px" arcsize="14%" stroke="f" fillcolor="#081b8b"> <w:anchorlock></w:anchorlock> <center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:17px; font-weight:400; line-height:17px; mso-text-raise:1px'>CONFIRM YOUR EMAIL</center> </v:roundrect></a><![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
                                                                        style="border-radius: 6px;background: #081b8b"><a
                                                                            href class="es-button" target="_blank"
                                                                            style="border-left-width: 30px;border-right-width: 30px;border-radius: 6px;background: #081b8b;border-color: #081b8b">CONFIRM
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-p35b">
                                                                    <p>Smart core-KSA © 2023 , Inc. All Rights Reserved.
                                                                    </p>
                                                                    <p><br></p>
                                                                </td>
                                                            </tr>
