                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hello, {{$mailData['customer_name']}}! Thanks for joining us! You are
                                                                        now on our mailing list. This means you'll be
                                                                        the first&nbsp;to hear about our
                                                                        fresh&nbsp;collections and offers!
                                                                        Please Click Below To Verify Your Email</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <!--[if mso]><a href="" target="_blank" hidden>
                                                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href=""
                                                                                        style="height:44px; v-text-anchor:middle; width:171px" arcsize="14%" stroke="f"  fillcolor="#242e3b">
                                                                    ...
                                                                    <!--[if !mso]><!-- --><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#2CB543;background:#5C68E2;border-width:0px;display:inline-block;border-radius:6px;width:auto;mso-hide:all;background-color:#242e3b"><a
                                                                            href="{{url('/verify/email/'.$mailData['token'])}}" class="es-button"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#242e3b;border-width:10px 30px 10px 30px;display:inline-block;background:#5C68E2;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;border-left-width:30px;border-right-width:30px;background-color:#242e3b">Click
                                                                            To Verify Email</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr>
